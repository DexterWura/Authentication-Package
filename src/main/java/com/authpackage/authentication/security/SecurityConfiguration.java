...
public class SecurityConfiguration {
    ...
    @Value("${auth.security.public-endpoints:/api/auth/**}")
    ...
    public SecurityConfiguration(JwtAuthenticationFilter jwtAuthFilter, UserDetailsService userDetailsService, RateLimitingFilter rateLimitingFilter) {
